...
- [ ] Add Expo unit/component tests for session restoration, API errors, entitlement gates, pattern binding, and destructive confirmations. *(2026-09-11: Expo now has a Node-backed unit-test script and pure entitlement-gate coverage for active, expired, free-tier, trial, store, Stripe, and manual access states. Session restoration, component-level API errors, pattern binding, and destructive confirmations remain.)*
