...
- [ ] Add Expo unit/component tests for session restoration, API errors, entitlement gates, pattern binding, and destructive confirmations. *(2026-09-11: Expo now has a Node-backed unit-test script plus pure coverage for entitlement gates and user-facing API error mapping, including auth expiry, Pro gating, support codes, route-not-found bridge guidance, rate limiting, and SecureStore recovery. Session restoration, component-level flows, pattern binding, and destructive confirmations remain.)*
