(function () {
  ...
  function formatAssistantText(text) {
    ...
    lines.forEach(function (rawLine) {
      ...
      if (headingMatch) {
        parts.push('<div class="ss-ai-heading">' + inlineFormat(headingMatch[1]) + '</div>');
        return;
      }
  ...
  function initHub(root) {
    ...
    function renderMessages() {
      ...
      messages.innerHTML = history.map(function (m, index) {
        ...
        return '<div class="ss-message ' + role + '"' + idAttr + '><div class="ss-bubble"><span class="ss-role">' + label + '</span>' + body + '</div></div>' + followups;
      }).join('');
    ...
    function initRework() {
      ...
      function copyReworkResult() {
        ...
        if (navigator.clipboard) {
          navigator.clipboard.writeText(reworkResultText);
